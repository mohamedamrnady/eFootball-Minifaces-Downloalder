...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python script_optimized.py                    # Run with default settings
  python script_optimized.py --debug           # Run with debug logging
  python script_optimized.py -d --quiet        # Debug mode with minimal output
        """,
    )
